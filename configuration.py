...
train_arg.add_argument('--N', type=int, default=5, help="number of speakers of batch")
...
train_arg.add_argument('--iteration', type=int, default=10000, help="max iteration") #100000 default by author(after 100000 iterations)
