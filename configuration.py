...
#data_arg.add_argument('--enroll_path', type=str, default='./enroll_tisv', help="enroll dataset directory")
#data_arg.add_argument('--verif_path',type=str, default='./verif_tisv', help="verif dataset directory")
data_arg.add_argument('--test_path', type=str, default='./test_tisv', help="test(enroll+verif) dataset directory")
...
data_arg.add_argument('--tdsv_frame', type=int, default=64, help="frame number of utterance of tdsv")
data_arg.add_argument('--tisv_frame', type=int, default=64, help="max frame number of utterances of tdsv")
...
model_arg.add_argument('--model_num', type=int, default=0, help="number of ckpt file to load") #6 default by author(after 60000 iterations)

# Training Parameters
train_arg = parser.add_argument_group('Training')
train_arg.add_argument('--train', type=str2bool, default=False, help="train session or not(test session)")
train_arg.add_argument('--N', type=int, default=2, help="number of speakers of batch")
...
train_arg.add_argument('--iteration', type=int, default=20000, help="max iteration") #100000 default by author(after 100000 iterations)
